...
import com.gwq.cloudpicturebackend.api.aliyunai.AliYunAiApi;
...
import com.gwq.cloudpicturebackend.manager.upload.FilePictureUpload;
import com.gwq.cloudpicturebackend.manager.upload.PictureUploadTemplate;
import com.gwq.cloudpicturebackend.manager.upload.UrlPictureUpload;
...
import com.gwq.cloudpicturebackend.model.enums.PictureReviewStatusEnum;
...
import com.gwq.cloudpicturebackend.mapper.PictureMapper;
import com.gwq.cloudpicturebackend.service.SpaceService;
import com.gwq.cloudpicturebackend.service.UserService;
import com.gwq.cloudpicturebackend.utils.ColorSimilarUtils;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public void doPictureReview(PictureReviewRequest pictureReviewRequest, User loginUser) {
        //校验参数
        ThrowUtils.throwIf(pictureReviewRequest == null, ErrorCode.PARAMS_ERROR, "请求为空");
        Long id = pictureReviewRequest.getId();
        Integer reviewStatus = pictureReviewRequest.getReviewStatus();
        PictureReviewStatusEnum reviewStatusEnum = PictureReviewStatusEnum.getEnumByValue(reviewStatus);
        String reviewMessage = pictureReviewRequest.getReviewMessage();
        if (id == null || reviewStatusEnum == null || PictureReviewStatusEnum.REVIEWING.equals(reviewStatusEnum)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "请求存在问题");
        }
        //判断图片是否存在
        Picture odlPicture = this.getById(id);
        ThrowUtils.throwIf(odlPicture == null, ErrorCode.NOT_FOUND_ERROR, "图片不存在");
        //校验审核状态是否重复
        if (odlPicture.getReviewStatus().equals(reviewStatus)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "重复审核");
        }
        //数据库操作
        Picture updatePicture = new Picture();
        BeanUtils.copyProperties(odlPicture, updatePicture);
    ...
    public CreateOutPaintingTaskResponse createPictureOutPaintingTask(CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, User loginUser) {
        ...
        return aliYunAiApi.createOutPaintingTaskRequest(createOutPaintingTaskRequest);
    }
