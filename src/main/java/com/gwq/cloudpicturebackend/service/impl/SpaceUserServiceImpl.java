...
import com.gwq.cloudpicturebackend.mapper.SpaceUserMapper;
...
public class SpaceUserServiceImpl extends ServiceImpl<SpaceUserMapper, SpaceUser>
    ...
    public long addSpaceUser(SpaceUserAddRequest spaceUserAddRequest) {
        ThrowUtils.throwIf(spaceUserAddRequest == null, ErrorCode.PARAMS_ERROR, "请求为空");
    ...
    public void validSpaceUser(SpaceUser spaceUser, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(spaceType == SpaceTypeEnum.PRIVATE.getValue(), ErrorCode.PARAMS_ERROR, "无法为私有空间添加成员");
        }
