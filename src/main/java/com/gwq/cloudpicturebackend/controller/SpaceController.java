...
import com.gwq.cloudpicturebackend.model.dto.space.*;
...
public class SpaceController {
    ...
    @PostMapping("/add")
    public BaseResponse<Long> add(SpaceAddRequest spaceAddRequest, HttpServletRequest request) {
        ThrowUtils.throwIf(spaceAddRequest == null, ErrorCode.PARAMS_ERROR, "请求为空");
    ...
    public BaseResponse<Boolean> deleteSpace(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        List<Picture> pictureList = pictureService.lambdaQuery()
                ...
                .list();
        List<Long> ids = pictureList.stream()
                .map(Picture::getId)
