...
import static com.gwq.cloudpicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceUserId != null) {
            spaceUser = spaceUserService.lambdaQuery().eq(SpaceUser::getUserId, spaceUserId).one();
            if (spaceUser == null) {
